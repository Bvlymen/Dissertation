...
def Get_Twitter_Data_As_Pandas(C_Key, C_Secret, A_Token, A_Token_Secret, Max_Tweets= 100, Filters = ["bitcoin"], Table_Name = "tmp_tweets", New_Table_Columns = None, Query = None, Tweet_Data_Parts = None, Temporary = True, *args, **kwargs):
    """
    ...
    if Tweet_Data_Parts and New_Table_Columns:    
        class Stream_Listener(tweepy.StreamListener):
            def __init__(self, api=None, Max_Tweets_=None, Table_Name_=None, New_Table_Columns_=None, Tweet_Data_Parts_ = None):
                ...
                exec_stmt = str("CREATE TABLE IF NOT EXISTS " + self.table_name + " " + self.new_table_columns + " CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci") 
    ...
    #Otherwise use the default listener and database/table
        ...
        class Stream_Listener(tweepy.StreamListener):
            def __init__(self, api=None, Max_Tweets_=None, Table_Name_=None, New_Table_Columns_=None, Tweet_Data_Parts_ = None):
                ...
                exec_stmt = str("CREATE TABLE IF NOT EXISTS " + self.table_name + " (date DATETIME, username VARCHAR(20), tweet VARCHAR(280)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci")  
...
def Stream_Twitter_Data_MYSQL(C_Key, C_Secret, A_Token, A_Token_Secret, Max_Tweets= 100, Filters = ["Bitcoin"], Table_Name = "tmp_tweets", New_Table_Columns = None, Tweet_Data_Parts = None, *args, **kwargs):
